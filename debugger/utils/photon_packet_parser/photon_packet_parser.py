...
from debugger.utils.photon_packet_parser.byte_reader import ByteReader
from debugger.utils.photon_packet_parser.command_type import CommandType
from debugger.utils.photon_packet_parser.crc_calculator import CrcCalculator
from debugger.utils.photon_packet_parser.message_type import MessageType
from debugger.utils.photon_packet_parser.number_serializer import \
    NumberSerializer
from debugger.utils.photon_packet_parser.protocol16_deserializer import \
    Protocol16Deserializer
from debugger.utils.photon_packet_parser.segmented_package import \
    SegmentedPackage
...
class PhotonPacketParser:
    ...
    def handle_send_fragment(self, source: io.BytesIO, command_length: int):
        ...
        self.handle_segmented_payload(
            sequence_number, total_length, fragment_length, fragment_offset, source
        )
    ...
    def get_segmented_package(self, start_sequence_number, total_length):
        ...
        segmented_package = SegmentedPackage(
    ...
    def handle_segmented_payload(
        ...
        segmented_package = self.get_segmented_package(
